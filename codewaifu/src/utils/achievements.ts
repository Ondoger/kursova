import type { Achievement, GitHubStats } from '../types';
...
export const evaluateAchievements = (stats: GitHubStats) => {
...
export const RARITY_COLORS: Record<Achievement['rarity'], { from: string; to: string; ring: string }> = {
