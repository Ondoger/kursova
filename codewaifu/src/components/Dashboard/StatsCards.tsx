  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
      {cards.map((c, i) => (
        ...
        >
          <div
            className="absolute -right-6 -top-6 w-24 h-24 rounded-full opacity-30 blur-2xl group-hover:opacity-60 transition-opacity"
          ...
          <div
            ...
            style={{ color: c.color, textShadow: `0 0 14px ${c.color}80` }}
          >
