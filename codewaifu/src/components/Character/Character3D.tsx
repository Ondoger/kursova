...
export function Character3D({ height = '40vh', interactive = false, showHud = true }: Props) {
  ...
  const animation: CharacterAnimation = loading ? 'climbing' : moodToAnimation(mood);
  ...
  return (
    ...
    >
      ...
      <Canvas
        camera={{ position: [0, 0.3, 4.4], fov: 35 }}
        dpr={[1, 2]}
