...
export function NeonButton({
  ...
  return (
    <motion.button
      ...
      onClick={onClick}
      className={`relative overflow-visible inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-display font-bold tracking-wider uppercase text-sm border-2 backdrop-blur-md transition-all ${baseStyles} ${className}`}
      {...rest}
    >
