import type { CharacterAnimation, CharacterMood } from '../types';
 ...
 */
export const ANIMATION_PATHS: Record<CharacterAnimation, string> = {
...
const MOOD_ANIMATION: Record<CharacterMood, CharacterAnimation> = {
  idle: 'idle',
...
export function moodToAnimation(mood: CharacterMood): CharacterAnimation {
