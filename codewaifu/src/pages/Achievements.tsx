...
const FILTERS: Array<{ id: 'all' | 'unlocked' | 'locked' | Achievement['rarity']; label: string }> = [
  { id: 'all', label: 'Усі' },
        ...
        <div className="space-y-2">
          ...
          <div className="h-3 rounded-full bg-white/5 overflow-hidden">
            <motion.div
              ...
              style={{
                boxShadow:
                  '0 0 14px rgba(0,255,255,0.6), 0 0 28px rgba(255,0,255,0.4)',
              }}
            />
          </div>
        </div>
      ...
      <div className="flex flex-wrap gap-2">
        {FILTERS.map((f) => (
          <button
            ...
            className={`px-3 py-1.5 rounded-full border text-xs font-display uppercase tracking-widest transition-all ${
              filter === f.id
