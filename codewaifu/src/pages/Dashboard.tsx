  ...
  if (!stats) {
    return (
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {error && (
          <div className="mt-6 text-center text-neon-pink">{error}</div>
        )}
      </div>
    );
  }
        ...
        <div className="space-y-4">
          ...
          <GlassCard glow="cyan">
            ...
            <button
              ...
              className="text-xs text-neon-cyan hover:text-white mt-3 inline-flex items-center gap-1 transition-colors"
            >
              Дивитись усі 
            </button>
          </GlassCard>
